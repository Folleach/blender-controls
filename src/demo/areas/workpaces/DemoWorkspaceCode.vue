...
service.add("index.js", new Workspace(new LeafArea<ICodeContext>(DEMO_AREA_CODE, { code: atob(CodeIndex) })))
service.add("App.vue", new Workspace(new LeafArea<ICodeContext>(DEMO_AREA_CODE, { code: atob(CodeApp) })));
service.add("DemoPlaceholderArea.vue", new Workspace(new LeafArea<ICodeContext>(DEMO_AREA_CODE, { code: atob(CodeDemoPlaceholderArea) })));
service.add("DemoWorkspaceExample.vue", new Workspace(new LeafArea<ICodeContext>(DEMO_AREA_CODE, { code: atob(CodeDemoWorkspaceExample) })));
